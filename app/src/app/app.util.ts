...
export class AppUtil {
    ...
    public static HtmlDecode(str) {
        ...
        var reg = new RegExp("\"/alucard263096/businessschool/upload/", "g"); //创建正则RegExp对象   
        s = s.replace(reg, "\"http://cmsdev.app-link.org/alucard263096/businessschool/upload/");
    ...
    public static StartDayOfWeek(dt) {
        var nowDayOfWeek = dt.getDay();
        var day = nowDayOfWeek || 7;
        return new Date(dt.getFullYear(), dt.getMonth(), dt.getDate() + 1 - day);
    }
}